...
static _pappl_txt_t	dns_sd_add_scanner_values(_pappl_txt_t txt, pappl_scanner_t *scanner);
...
//
// 'dns_sd_add_scanner_values()' - Add scanner TXT values.
//

static _pappl_txt_t			// O - Updated TXT record
dns_sd_add_scanner_values(
    _pappl_txt_t    txt,		// I - TXT record
    pappl_scanner_t *scanner)		// I - Scanner
{
  // TODO: Get ADF and TMA values from the scanner capabilities
  char	ADF = 'N',			// Auto-document feeder?
	TMA = 'U';			// Transparency adapter?
