...
"\"  add PRINTER      Add a printer.\" = \"PRINTERを追加 プリンターを追加\";\n"
"\"  autoadd          Automatically add supported printers.\" = \"自動追加 サポートされているプリンターを自動的に追加します。\";\n"
"\"  cancel           Cancel one or more jobs.\" = \"キャンセル 1 つ以上のジョブをキャンセルします。\";\n"
"\"  default          Set the default printer.\" = \"デフォルト デフォルトプリンタを設定します。\";\n"
"\"  delete           Delete a printer.\" = \"プリンターを削除します。\";\n"
"\"  devices          List devices.\" = \"デバイス リストデバイス。\";\n"
"\"  drivers          List drivers.\" = \"ドライバー リストドライバー。\";\n"
"\"  jobs             List jobs.\" = \"求人情報 ジョブリスト\";\n"
"\"  modify           Modify a printer.\" = \"プリンターを変更します。\";\n"
"\"  options          List printer options.\" = \"オプション プリンターオプションをリストします。\";\n"
"\"  pause            Pause printing for a printer.\" = \"一時停止 プリンターのプリント\";\n"
"\"  printers         List printers.\" = \"プリンター プリンターリスト\";\n"
"\"  resume           Resume printing for a printer.\" = \"プリンター用のResumeの印刷を再開します。\";\n"
"\"  server           Run a server.\" = \"サーバはサーバを実行します。\";\n"
"\"  shutdown         Shutdown a running server.\" = \"実行中のサーバーをシャットダウンします。\";\n"
"\"  status           Show server/printer/job status.\" = \"ステータス サーバ/プリンター/ジョブの状態を表示します。\";\n"
"\"  submit           Submit a file for printing.\" = \"印刷用のファイルを提出してください。\";\n"
"\"%d inches/sec\" = \"%dインチ/秒\";\n"
"\"%d job\" = \"%d ジョブ\";\n"
...
"\"Confirm Cancel Job\" = \"キャンセルジョブの確認\";\n"
...
"\"Job #\" = \"求人番号\";\n"
"\"Jobs\" = \"求人情報\";\n"
"\"Joining Wi-Fi network.\" = \"Wi-Fiネットワークに参加\";\n"
"\"Jordan\" = \"ヨルダン\";\n"
"\"Kazakhstan\" = \"カザフスタン\";\n"
"\"Kenya\" = \"ケニア\";\n"
"\"Kiribati\" = \"キリバティ\";\n"
