...
struct _pappl_scanner_s			// Scanner data
{
  ...
  ipp_sstate_t		state;			// "scanner-state" value
  pappl_sreason_t	state_reasons;		// "scanner-state-reasons" values
...
extern ipp_t		*_papplMediaColExport(pappl_sc_driver_data_t *driver_data, pappl_media_col_t *media, bool db) _PAPPL_PRIVATE;
