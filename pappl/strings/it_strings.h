...
"\"  cancel           Cancel one or more jobs.\" = \"  cancel           Cancella uno o più0f9 lavori.\";\n"
...
"\"  modify           Modify a printer.\" = \"  modify           una stampante.\";\n"
...
"\"  resume           Resume printing for a printer.\" = \"  resume           la stampa per una stampante.\";\n"
"\"  server           Run a server.\" = \"  server           Eseguire un server.\";\n"
"\"  shutdown         Shutdown a running server.\" = \"  shutdown         un server in esecuzione.\";\n"
...
/* Source/Tray Media */
"\"%s Media\" = \"%s dei media\";\n"
"\"%s: Cannot specify more than one sub-command.\" = \"%s: Non è0e8 possibile specificare più0f9 di un sottocomando.\";\n"
"\"%s: Missing copy count after '-n'.\" = \"%s: numero di copie mancanti dopo -n.\";\n"
...
"\"%s: Missing job ID after '-j'.\" = \"%s: ID mancante dopo -j.\";\n"
"\"%s: Missing option(s) after '-o'.\" = \"%s: opzione mancante (s) dopo -o.\";\n"
"\"%s: Missing printer URI after '-u'.\" = \"%s: URI stampante mancante dopo -u.\";\n"
"\"%s: Missing printer name after '-d'.\" = \"%s: nome della stampante mancante dopo -d.\";\n"
"\"%s: Missing space after '-o'.\" = \"%s: spazio mancante dopo -o.\";\n"
"\"%s: Missing title after '-t'.\" = \"%s: titolo mancante dopo -t.\";\n"
"\"%s: Sub-command '%s' does not accept files.\" = \"%s: Il subcomand % non accetta i file.\";\n"
"\"%s: Sub-command 'autoadd' is not supported.\" = \"%s: Sub-command autoadd non è0e8 supportato.\";\n"
"\"%s: Too many files.\" = \"%s: Troppi file.\";\n"
"\"%s: Unable to access '%s': %s\" = \"%s: Incapace di accedere a %s: %s\";\n"
"\"%s: Unknown option '%s'.\" = \"%s: Variazioni sconosciute %.\";\n"
"\"%s: Unknown option '-%c'.\" = \"%s: opzione sconosciuta -%c.\";\n"
"\"%s: Unknown sub-command '%s'.\" = \"%s: Sottocomandi sconosciuti.\";\n"
"\", Borderless\" = \"♪66a\";\n"
"\"A printer with that name already exists.\" = \"Una stampante con quel nome esiste già0e0.\";\n"
"\"Aborted at %s\" = \"Interrotta a %s\";\n"
...
"\"Invalid GET data.\" = \"Dati GET non validi.\";\n"
...
"\"Job #\" = \"Lavoro\";\n"
"\"Jobs\" = \"Lavoro\";\n"
"\"Joining Wi-Fi network.\" = \"Unisciti alla rete Wi-Fi.\";\n"
"\"Jordan\" = \"Giordania\";\n"
...
"\"Paraguay\" = \"Paraguay\";\n"
"\"Password\" = \"Password\";\n"
"\"Password changed.\" = \"La password è0e8 cambiata.\";\n"
...
"\"Printer is currently active.\" = \"La stampante è0e8 attualmente attiva.\";\n"
...
"\"Thailand\" = \"Thailandia\";\n"
"\"This form creates a certificate signing request ('CSR') that you can send to a Certificate Authority ('CA') to obtain a trusted TLS certificate. The private key is saved separately for use with the certificate you get from the CA.\" = \"Questo modulo crea una richiesta di firma del certificato (CSR) che è0e8 possibile inviare a un'Autorità0e0 di certificazione (CA) per ottenere un certificato TLS affidabile. La chiave privata viene salvata separatamente per l'uso con il certificato che si ottiene dalla CA.\";\n"
...
"\"This form will install a trusted TLS certificate you have obtained from a Certificate Authority ('CA'). Once installed, it will be used immediately.\" = \"Questo modulo installerà0e0 un certificato TLS di fiducia che hai ottenuto da un'Autorità0e0 di certificazione (CA.) Una volta installato, verrà0e0 utilizzato immediatamente.\";\n"
...
"\"Uganda\" = \"Uganda\";\n"
"\"Ukraine\" = \"Ucraina\";\n"
"\"Unable to access test print file.\" = \"Non è0e8 possibile accedere al file di stampa di prova.\";\n"
"\"Unable to create certificate request.\" = \"Non è0e8 possibile creare una richiesta di certificato.\";\n"
"\"Unable to create certificate.\" = \"Non è0e8 possibile creare un certificato.\";\n"
...
"\"Unable to join Wi-Fi network.\" = \"Non è0e8 possibile accedere alla rete Wi-Fi.\";\n"
...
"\"Uruguay\" = \"Uruguay\";\n"
"\"Usage: %s SUB-COMMAND [OPTIONS] [FILENAME]\\n\" = \"Utilizzo: % SUB-COMMAND [OPTIONS] [FILENAME]\\n\";\n"
...
"\"finishings.86\" = \"Punzone a più0f9 buche sinistra\";\n"
...
"\"media-source.large-capacity\" = \"Grande capacità0e0\";\n"
...
"\"media-type.multi-part-form\" = \"Forma a più0f9 parti\";\n"
...
"\"output-bin.large-capacity\" = \"Grande capacità0e0\";\n"
...
"\"print-color-mode\" = \"Modalità0e0 di stampa\";\n"
...
"\"print-darkness\" = \"Stampa Oscurità0e0\";\n"
"\"print-quality\" = \"Qualità0e0 della stampa\";\n"
...
"\"print-speed\" = \"Velocità0e0 di stampa\";\n"
