...
extern int	_papplMainloopAutoAddPrinters(const char *base_name, int num_options, cups_option_t *options, pappl_ml_autoadd_cb_t autoadd_cb, void *data) _PAPPL_PRIVATE;
...
extern int	_papplMainloopRunServer(const char *base_name, const char *version, const char *footer_html, int num_drivers, pappl_pr_driver_t *drivers, pappl_pr_driver_cb_t driver_cb, int num_options, cups_option_t *options, pappl_ml_system_cb_t system_cb, void *data) _PAPPL_PRIVATE;
