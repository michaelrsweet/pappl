...
"\"%s: Unable to add '%s': %s\" = \"%s: Nie można dodać '%s': %s\";\n"
...
"\"Unable to join Wi-Fi network.\" = \"Nie można dołączyć do sieci Wi-Fi.\";\n"
"\"Unable to lookup address.\" = \"Nie można wyszukać adresu.\";\n"
"\"Unable to save network configuration.\" = \"Nie można zapisać konfiguracji sieci.\";\n"
