...
extern void	papplMainloopSetScannerDrivers(size_t num_drivers, pappl_sc_driver_t *drivers, pappl_sc_autoadd_cb_t autoadd_cb, pappl_sc_driver_cb_t driver_cb) _PAPPL_PUBLIC;
